...
public class USERCOUNTRY extends TableImpl<UsercountryRecord> {
     ...
     */
    public static final USERCOUNTRY USERCOUNTRY = new USERCOUNTRY();
    ...
    @Override
    public USERCOUNTRY as(String alias) {
        return new USERCOUNTRY(DSL.name(alias), this);
    }

    @Override
    public USERCOUNTRY as(Name alias) {
     ...
     */
    @Override
    public USERCOUNTRY rename(String name) {
     ...
     */
    @Override
    public USERCOUNTRY rename(Name name) {
